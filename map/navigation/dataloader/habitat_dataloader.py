...
from map.utils.mapping_utils import cvt_pose_vec2tf, base_pos2grid_id_3d, grid_id2base_pos_3d, base_rot_mat2theta
...
class VLMapsDataloaderHabitat:
    ...
    def get_color_topdown_bgr_cropped(self, times: float = 1) -> np.array:
        ...
        # )
        return cv2.cvtColor(self.map.rgb_topdown, cv2.COLOR_RGB2BGR)
    ...
    def to_cropped_map_pose(self) -> Tuple[int, int, float]:
        ...
        # print(self.full_map_pose)
        # self.full_map_pose[1] -= 400
        # raise Exception("Must not be here")
