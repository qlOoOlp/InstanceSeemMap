...
class RegionAlignedModel(VLFM):
    def __init__(self, name, **kwargs) -> None:
        ...
        if name == "seem":
            from seem.xdecoder_seem.model import BaseModel
            from seem.xdecoder_seem.xdecoder import build_model
            from seem.xdecoder_seem.utils.distributed import init_distributed
            from seem.xdecoder_seem.utils.arguments import load_opt_from_config_files
