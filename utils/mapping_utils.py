...
def get_sim_cam_mat4Real(cam_mat, original_resolution, target_resolution):
    # original resolution : rgb image resolution
    # target resolution : depth image resolution or feature resolution
    h_ratio = target_resolution[0] / original_resolution[0] # 90/480
    w_ratio = target_resolution[1] / original_resolution[1] # 120/640

    cam_mat[0,0] = cam_mat[0,0] * w_ratio
    cam_mat[0,2] = cam_mat[0,2] * w_ratio
    cam_mat[1,1] = cam_mat[1,1] * h_ratio
    cam_mat[1,2] = cam_mat[1,2] * h_ratio
    return cam_mat